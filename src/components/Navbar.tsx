  ...
  return (
    <header className="bg-white text-slate-900 border-b border-slate-200 sticky top-0 z-40 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div>
              <div className="flex items-center space-x-2">
                ...
                {activeJudgeId && (
                  <span className="text-[10px] font-black uppercase tracking-wider text-emerald-700 bg-emerald-100 border border-emerald-200 px-2 py-0.5 rounded flex items-center gap-1">
        ...
        {/* Mobile Navigation Tabs (Touch-optimized bar) */}
