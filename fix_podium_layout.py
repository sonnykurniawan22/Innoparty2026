...
# Replace images with Google Drive IDs via Google Drive viewer or just keep them as robot_X.png
# and ask user to upload them. I will revert to `/robot_X.png` because the gdrive links don't work directly in <img> without proxy.
# I'll also fix the overlapping issue.
        ...
        {rankedData.length > 0 && (
          <div className="p-6 md:p-10 relative">
            ...
            <div className="flex flex-col md:flex-row justify-center items-end gap-12 md:gap-8 h-auto md:h-[480px] pt-16 md:pt-24 pb-8">
              ...
              {/* Champion */}
              <div className="podium-card champion-card w-full md:w-[35%] bg-surface-container-lowest rounded-xl border-2 border-primary-container flex flex-col items-center relative pb-6 pt-20 order-1 md:order-2 h-auto md:h-full z-20 mt-16 md:mt-0">
